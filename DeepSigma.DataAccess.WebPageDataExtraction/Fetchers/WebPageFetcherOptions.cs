...
/// <summary>Configuration options for <see cref="HttpWebPageFetcher"/> and <see cref="PlaywrightWebPageFetcher"/>.</summary>
public sealed class WebPageFetcherOptions
{
    /// <summary>
    /// User-Agent header sent with every request. Defaults to the DeepSigmaBot identifier.
    /// </summary>
